...
import time
# global variables
api_key = 'f66e6d20-4970-49d0-827d-213ee1d075a1'
bot_token = '2078166144:AAEcBZNFrFluEf_EVude8DscldE0mn23_XQ'
chat_id = '1132687589'
threshold = 30000
...
# send last 6 btc price
        if len(price_list) >= 6:
            send_message(chat_id=chat_id, msg=f'BTC Price Update: {price_list}')
